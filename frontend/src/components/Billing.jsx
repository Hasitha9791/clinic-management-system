                        ...
                        <td>
                          <div style={{ display: 'flex', alignItems: 'center', gap: '0.25rem' }}>
                            ...
                            <input
                              ...
                              className="form-input"
                              style={{ width: '100px', padding: '0.2rem 0.4rem', margin: 0, fontSize: '0.9rem', textAlign: 'right' }}
                              min="0"
                              step="any"
                            />
                          </div>
                          ...
                          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.15rem' }}>
                            <input
                              ...
                              onChange={(e) => {
                                ...
                                setCart(prev => prev.map((c, i) => i === index ? { ...c, qty: newQty < 1 ? 1 : newQty } : c));
                              }}
                              className="form-input"
                              style={{ 
                                width: '75px', 
                                ...
                                borderColor: (() => {
                                  if (item.id && item.id.startsWith('inv_')) {
                                    const invItem = inventory.find(i => i.id === item.id);
                                    if (invItem && item.qty > invItem.qty) return 'var(--danger)';
                                  }
                                  return 'var(--border)';
                                })()
                              }}
                            ...
                            {(() => {
                              if (item.id && item.id.startsWith('inv_')) {
                                const invItem = inventory.find(i => i.id === item.id);
                                if (invItem) {
                                  const isLow = item.qty > invItem.qty;
                                  return (
                                    <span style={{ 
                                      fontSize: '0.7rem', 
